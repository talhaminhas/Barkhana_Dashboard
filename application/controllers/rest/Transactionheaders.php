...
class Transactionheaders extends API_Controller
{
	...
	*/
	...
	{	
		...
		if($global_result==1 || $paypal_result == 1 || $stripe_result == 1 || $cod_result == 1 || $pickup_result == 1 || $bank_result == 1 || $razor_result == 1 || $paystack_result == 1 || $flutter_wave_result == 1) {
