	            ...
	            <div class="row">
	             	<div class="col-md-6">
						...
						<div class="form-group">
							<label> <span style="font-size: 17px; color: red;">*</span>
								...
								<input type="hidden" id="header_id" name="header_id" value="<?php echo $this->Prd_attribute->get_one($header_id)->id; ?>">
								<?php 

									$name = $this->Prd_attribute->get_one($header_id)->name;
									echo $name;
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<label><?php echo get_msg('attribute_detail_extra_price'); ?></label>
