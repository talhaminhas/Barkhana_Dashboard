...
class Shopusers extends BE_Controller {
	...
	function index() {
		...
		// get rows count
		$this->data['rows_count'] = $this->User_shop->count_all( );

		// get users
		$this->data['users'] = $this->User_shop->get_shop_admin( $this->pag['per_page'], $this->uri->segment( 4 ) );
