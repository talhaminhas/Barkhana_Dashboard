...
/**
 * Purchasedproducts Controller
 */
class Purchasedproducts extends BE_Controller {
	...
	function __construct() {
		...
		parent::__construct( MODULE_CONTROL, 'Most Purshased Products' );
	...
	function index() {
		...
		// get categories
		$this->data['purchasedproducts'] = $this->Purchasedproduct->get_purchased_product_by( $conds , $this->pag['per_page'], $this->uri->segment( 4 ) );
	...
	function search() {
		...
		// breadcrumb urls
		$this->data['action_title'] = get_msg( 'purchased_prd_search' );
	...
	/**
		...
		*/
		...
		// load user
		$this->data['purchasedproduct'] = $this->Purchasedproduct->get_one( $id );
