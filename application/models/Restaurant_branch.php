 ...
 */
class Restaurant_branch extends PS_Model {
	...
	{
		parent::__construct( 'rt_restaurant_branches', 'id', 'res_bra' );
	}
	...
	function custom_conds( $conds = array())
	{
		...
		if ( isset( $conds['order_by'] )) {
			...
			$this->db->order_by( 'rt_restaurant_branches.'.$order_by_field, $order_by_type);
		}
